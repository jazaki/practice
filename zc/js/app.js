...
$(document).ready(function () {
  ...
  $('#fullpage').fullpage({
    ...
    sectionsColor: ['transparent', '#ffffff', '#0084ff', '#ffffff', '#0084ff', '#ffffff', '#0084ff', 'transparent'],
    navigation: true,
    ...
    onLeave: function (index, nextIndex, direction) {
      ...
      */
      ...
      if (index == 1 && nextIndex == 2) {
        $isAnimatedFirst.eq(0).addClass('animated fadeInLeftBig').css('animation-delay', '.3s');
        $isAnimatedFirst.eq(1).addClass('animated fadeInRightBig').css('animation-delay', '.6s');
    ...
    $isAnimatedSecond.eq(0).addClass('animated fadeInLeftBig').css('animation-delay', '.3s');
    ...
    $isAnimatedThird.eq(1).addClass('animated fadeInRightBig').css('animation-delay', '.6s');
  }
  ...
  // fourth animation
    ...
    $isAnimatedFourth.eq(0).addClass('animated fadeInLeftBig').css('animation-delay', '.3s');
    $isAnimatedFourth.eq(1).addClass('animated fadeInRightBig').css('animation-delay', '.6s');
  }
  ...
  // fifth animation
    ...
    $isAnimatedFifth.eq(1).addClass('animated fadeInRightBig').css('animation-delay', '.6s');
  }
  ...
  // seventh animation
    ...
    $isAnimatedSeventh.eq(0).addClass('animated fadeInLeftBig').css('animation-delay', '.3s');
    $isAnimatedSeventh.eq(1).addClass('animated fadeInRightBig').css('animation-delay', '.6s');
  }
